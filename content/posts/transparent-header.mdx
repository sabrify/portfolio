...
- [Step 1: Making the Header Transparent](#step-1-making-the-header-transparent)
- [Step 2: Styling the Header Content](#step-2-styling-the-header-content)
- [Step 3: Ensuring Main Content Stays Below](#step-3-ensuring-main-content-stays-below)
- [Step 4: Styling the Banner Image](#step-4-styling-the-banner-image)
...
<HeadingWithId id="step-1-making-the-header-transparent" as="h2">Step 1: Making the Header Transparent</HeadingWithId>
...
<HeadingWithId id="step-2-styling-the-header-content" as="h2">Step 2: Styling the Header Content</HeadingWithId>
...
<HeadingWithId id="step-3-ensuring-main-content-stays-below" as="h2">Step 3: Ensuring the Main Content Stays Below</HeadingWithId>
...
<HeadingWithId id="step-4-styling-the-banner-image" as="h2">Step 4: Styling the Banner Image</HeadingWithId>
...
<HeadingWithId id="final-steps" as="h2">Final Steps</HeadingWithId>
